...
test('Room details can render validation errors', async () => {
    ...
    const putMock = nock('http://localhost')
                        ...
                        .reply(400, {
                            "errorCode": 400,
                            "error": "BAD_REQUEST",
                            "errorMessage": "Validation failed for argument [0] in public org.springframework.http.ResponseEntity<com.rbp.model.db.Room> com.rbp.api.RoomController.updateRoom(com.rbp,java.lang.String) throws java.sql.SQLException: [Field error in object 'room' on field 'type': rejected value [single]; codes [Pattern.room.type,Pattern.type,Pattern.java.lang.String,Pattern]; arguments [org.springframework.context.support.DefaultMessageSourceResolvable: codes [room.type,type]; arguments []; default message [type],[Ljavax.validation.constraints.Pattern$Flag;@21a98ac5,Single|Double|Twin|Family|Suite]; default message [Type can only contain the room options Single, Double, Twin, Family or Suite]] ",
